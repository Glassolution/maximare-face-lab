...
export default function Results() {
  ...
  return (
    <div className="min-h-screen bg-background text-white flex flex-col items-center justify-center px-3 py-4">
      <div className="w-full max-w-[390px] mx-auto flex flex-col items-center">
        <div className="relative mb-4">
          <div className="w-[102px] h-[102px] rounded-full overflow-hidden border-2 border-white/10 ring-4 ring-primary/5">
        ...
        <div className="text-center mb-4">
          <div className="inline-block">
            <div className="flex items-center justify-center gap-1.5 mb-1">
              <span className="px-2 py-0.5 text-[8px] font-mono tracking-widest text-primary border border-primary/40 rounded bg-primary/5 uppercase">
                {rankLabel}
              </span>
            ...
            <p className="text-white/40 text-[8px] font-mono uppercase tracking-[0.2em] text-center">
              Análise Maximare
            </p>
          </div>
        </div>

        <div className="w-full bg-black/40 backdrop-blur-xl border border-white/10 rounded-[24px] p-4 shadow-2xl relative overflow-hidden">
          <div
          ...
          <div className="grid grid-cols-2 gap-x-5 gap-y-4 relative z-10">
            ...
            >
              ...
              <div className={!isPremium ? "blur-sm opacity-50" : ""}>
                <p className="text-sm font-semibold text-white">{jawType}</p>
                <div className="w-full bg-white/10 rounded-full overflow-hidden h-[2px]">
                  <div
                    className="h-full rounded-full"
            ...
            >
              ...
              <div className={!isPremium ? "blur-sm opacity-50" : ""}>
                <p className="text-sm font-semibold text-white">{harmony}</p>
                <div className="w-full bg-white/10 rounded-full overflow-hidden h-[2px]">
                  <div
                    className="h-full rounded-full"
            ...
            >
              ...
              <div className={!isPremium ? "blur-sm opacity-50" : ""}>
                <p className="text-sm font-semibold text-white">{symmetry}</p>
                <div className="w-full bg-white/10 rounded-full overflow-hidden h-[2px]">
                  <div
                    className="h-full rounded-full"
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm font-semibold text-white">{appealLevel}</p>
              <div className="w-full bg-white/10 rounded-full overflow-hidden h-[2px]">
                <div
                  className="h-full rounded-full"
        ...
        <div className="mt-5 opacity-30 flex flex-col items-center gap-1.5">
      ...
      {/* Music Card */}
        {result.song_match && (
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="rounded-2xl glass-strong p-3">
            <h3 className="text-xs font-bold text-foreground mb-2">Sua música</h3>
            <div className="flex items-center justify-between gap-2">
              <div>
                <p className="text-xs font-semibold text-foreground">{result.song_match.track_name}</p>
                <p className="text-[10px] text-muted-foreground">{result.song_match.artist}</p>
