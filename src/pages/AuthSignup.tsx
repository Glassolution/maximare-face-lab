      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            />
            <p className="text-[11px] text-muted-foreground">Mínimo 3 caracteres. Letras, números, ponto e underscore.</p>
          </div>
          ...
          <Button type="submit" disabled={loading} className="w-full rounded-xl py-5 text-base font-bold glow-primary">
            {loading ? <Loader2 className="h-5 w-5 animate-spin" /> : <><UserPlus className="h-4 w-4 mr-2" /> Criar conta</>}
          </Button>
        </form>
