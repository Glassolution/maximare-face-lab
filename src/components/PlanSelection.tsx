    ...
    <div className="flex flex-col h-full bg-background-light dark:bg-background-dark text-foreground">
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-32">
        ...
        <div className="space-y-5">
          ...
          <div 
            ...
            className={`relative group cursor-pointer p-5 rounded-2xl border transition-all duration-300 ${
              selected === 'weekly' 
                ? 'border-2 border-primary bg-white dark:bg-graphite shadow-[0_0_20px_rgba(59,130,246,0.15)]' 
          ...
          >
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Ciclo curto de 7 dias</p>
              </div>
              <div className="text-right">
                <span className="text-lg font-bold text-gray-900 dark:text-white">R$ {PLAN_CONFIG.PLANS.weekly.price.toFixed(2)}</span>
                <p className="text-[10px] text-gray-400 uppercase font-medium">Por Semana</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Ciclo biológico de 30 dias</p>
              </div>
              <div className="text-right">
                <span className="text-lg font-bold text-gray-900 dark:text-white">R$ {PLAN_CONFIG.PLANS.monthly.price.toFixed(2)}</span>
                <p className="text-[10px] text-gray-400 uppercase font-medium">Por Mês</p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 italic mt-1">Evolução de longo prazo</p>
              </div>
              <div className="text-right">
        ...
        <div className="mt-10 space-y-5">
          <h4 className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] mb-4 pl-1">Incluso em todos os planos</h4>
          
          <div className="flex items-start space-x-3 group">
            <div className="mt-0.5 w-5 h-5 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
              <Check className="w-3 h-3 text-primary" />
            </div>
            <div>
              <p className="text-sm font-semibold text-gray-800 dark:text-gray-200">Relatório Biométrico Completo</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Análise detalhada de 42 pontos faciais & índices de simetria.</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3 group">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Rotinas personalizadas baseadas em dados para otimização estética.</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3 group">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Monitore mudanças com scans mensais e análise de tendências.</p>
            </div>
          </div>
        </div>
      </div>
