const url = 'https://xbtendfjajspaidpktsw.supabase.co/functions/v1/admin-cancel-feedback-by-handle';
const anon =
...
if (!handle) {
  console.error('Usage: node scripts/cancel-feedback-by-handle.mjs <username|public_id|short_id>');
  process.exit(1);
}
