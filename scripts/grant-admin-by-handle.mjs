const url = 'https://xbtendfjajspaidpktsw.supabase.co/functions/v1/admin-grant-admin-by-handle';
const anon =
...
if (!handle) {
  console.error('Uso: node scripts/grant-admin-by-handle.mjs <username|public_id|short_id>');
  process.exit(1);
}
