const url = 'https://xbtendfjajspaidpktsw.supabase.co/functions/v1/admin-reset-subscription-by-handle';
const anon =
...
if (!handle) {
  console.error('Usage: node scripts/reset-subscription-by-handle.mjs <username|public_id|short_id>');
  process.exit(1);
}
