const url = 'https://xbtendfjajspaidpktsw.supabase.co/functions/v1/admin-grant-premium-by-handle';
const anon =
...
if (!handle) {
  console.error('Uso: node scripts/grant-premium-by-handle.mjs <username|public_id|short_id> [weekly|monthly|annual]');
  process.exit(1);
}

const body = JSON.stringify({ handle, plan });
